...
<html> 
	<head>
		...
		<script src="./../../js/jsfuntions/server.js" type="text/javascript" charset="utf-8" async defer></script>		
	</head>
	<body>	
	...
	<div class="col-md-4 col-md-offset-1 form-registro">
		...
		<form method="post" action="./../../index.php/Profesor/registrarProfesor" name="form1">
