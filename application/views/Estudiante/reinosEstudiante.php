        ...
        <div id="featured">
            <form method="post" name="formActualizar">
                <div class="container">
                    <?php
                    if (isset($perfil)) {
                        echo "<h1 class='titulo_pagina'>" . $perfil[0]['k_nickname'] . "</h1>";
                    }
                    ?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php
                                        if (isset($perfil)) {
                                            echo "<input type='text' id='Nombre' name='Nombre' disabled='true' class='form-control' aria-describedby='basic-addon1' value='" . $perfil[0]['n_nombre'] . "'>";
                                        }
                                        ?>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        ...
                                        <?php
                                        if (isset($perfil)) {
                                            echo "<input type='text' id='Apellido' name='Apellido' disabled='true' class='form-control' aria-describedby='basic-addon1' value='" . $perfil[0]['n_apellido'] . "'>";
                                        }
                                        ?>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        ...
                                        <?php
                                        if (isset($perfil)) {
                                            echo "<input id='CorreoE' name='CorreoE' type='text' class='form-control' disabled  aria-describedby='basic-addon1' value='" . $perfil[0]['o_correo'] . "'>";
                                        }
                                        ?>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        ...
                                        <?php
                                        if (isset($perfil)) {
                                            echo "<input id='TelefonoE' name='TelefonoE' type='text' class='form-control' disabled aria-describedby='basic-addon1' value='" . $perfil[0]['o_num_tel'] . "'>";
                                        }
                                        ?>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        ...
                                        <?php
                                        if (isset($perfil)) {
                                            echo "<input id='ColegioE' name='ColegioE' type='text' class='form-control' disabled='true' aria-describedby='basic-addon1' value='" . $perfil[0]['n_colegio'] . "'>";
                                        }
                                        ?>
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        ...
                                        <?php
                                        if (isset($perfil)) {
                                            echo "<input id='GradoE' name='GradoE' type='text' class='form-control' disabled='true' aria-describedby='basic-addon1' value='" . $perfil[0]['o_grado_actual'] . "'>";
                                        }
                                        ?>
                                    </div>
                                        <?php
                                        if (isset($perfil)) {
                                            echo "<input id='NicknameE' name='NicknameE' type='hidden' value='" . $perfil[0]['k_nickname'] . "'>";
                                        }
                                        ?>
                                    <br>
