			...
			<div class="container">				
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="/Arcadia/index.php/reino/obtenerReinosProfesorC">Perfil</a></li>
		...
		<div id="featured">
			<div class="container">
				<div class="row">
					...
					<div class="3u">
						<section>
							<a href="/Arcadia/index.php/reino/obtenerImagenReinosC" class="image full"><img src="/Arcadia/assets/imagenes/reino.jpg" alt=""></a>
							<header>
								<h2>Crea tu Reino</h2>
							</header>
