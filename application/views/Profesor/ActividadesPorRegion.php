                                    ...
                                    if (isset($regiones)) { 
                                        for($i=0; $i<count($regiones);$i++){                                                                                             
                                            ...
                                            for($j=0;$j<count($regiones[$i]['actividades']);$j++){                                                
                                                echo "<tr>";    
                                                echo "<td><input type='checkbox' class='checkActividad' id='check".$regiones[$i]['actividades'][$j]['k_actividad']."' onclick='checkboxEstado(".json_encode($regiones[$i]['actividades'][$j]).")'></td>" ;                                                  echo "<td>".$regiones[$i]['actividades'][$j]['n_nombre']."</td>";
